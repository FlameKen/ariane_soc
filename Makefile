...
ariane_pkg := include/riscv_pkg.sv                          \
              ...
              src/mop/instr_pkg.vhd                         \
              src/mop/instr_pkg2.vhd                         \
...
CFLAGS := -I$(QUESTASIM_HOME)/include         \
          -I$(RISCV)/include  \
	  -I/home/software/modelsim/modeltech/include  \
          -std=c++11 -I../tb/dpi
...
src :=  $(filter-out src/ariane_regfile.sv, $(wildcard src/*.sv))      \
        ...
        $(wildcard bootrom/*.sv)                                       \
        $(wildcard src/fuse_mem/*.sv)                                  \
        $(wildcard src/pkt/*.sv)                                       \
        $(wildcard src/acct/*.sv)                                      \
        $(wildcard src/mop/*.vhd)                                      \
        $(wildcard src/reglk/*.sv)                                     \
        $(wildcard src/clint/*.sv)                                     \
        $(wildcard src/debug2/*.sv)                                     \
